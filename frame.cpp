	...
	:wxDialog(ParentPtr,wxID_ANY, GetMsg(MSG_MARKER), wxDefaultPosition, wxDefaultSize, wxCAPTION )
{
	...
	GridSizer->Add(MarkerIcon,0,wxALL,5);
	
		
	PanelIcon = new wxPanel(Panel,wxID_ANY,wxDefaultPosition,wxDefaultSize);
	PanelSizer->Add(PanelIcon,1,wxALL|wxEXPAND,5);
	...
	Scroll = new wxScrolledWindow(PanelIcon, wxID_ANY, wxDefaultPosition, wxDefaultSize,wxSUNKEN_BORDER);
	PanelIconSizer->Add(Scroll,1,wxALL|wxEXPAND,5);
